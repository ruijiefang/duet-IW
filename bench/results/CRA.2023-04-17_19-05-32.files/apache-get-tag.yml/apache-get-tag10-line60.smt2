...
(declare-const |havoc:5:17:90:139| Int)
(declare-const |K:105:106:111| Int)
(declare-const |havoc:8:19:140| Int)
...
(assert (and (<= (+ (- havoc) 1) 0)
               ...
               (not (= |havoc:5:17:90:139| 0)) (not (= |havoc:8:19:140| 0))
               (<= (- |t':64:107:112|) 0)
               (<= (+ |t':64:107:112| (- havoc) 1) 0)
               (= (+ |t':64:107:112| (- havoc) 2) 0)
               (not (<= (+ (- |t':64:107:112|) -1) 0))))
(check-sat)
